...
**Empfohlene Migration**: Verwenden Sie `gemini-2.0-flash` oder `gemini-2.0-flash-lite` für bessere Leistung und fortlaufende Unterstützung. Die Aliase `gemini-1.5-pro` und `gemini-1.5-flash` funktionieren bis zum 24. September 2025 weiterhin, da sie auf die -002-Versionen verweisen.
...
```bash
# Für die Verwendung von OpenAI-Modellen (GPT-4o, etc.)
...
os.environ["OPENAI_API_KEY"] = "your-openai-api-key"      # Für GPT-4o/4.1-Modelle (empfohlen)
os.environ["ANTHROPIC_API_KEY"] = "your-anthropic-api-key"  # Für Claude-3.7/3.5-Modelle
os.environ["GEMINI_API_KEY"] = "your-gemini-api-key"      # Für Google Gemini-2.0-Modelle
os.environ["QWEN_API_KEY"] = "your-qwen-api-key"        # Für Alibaba Qwen2.5-Modelle
...
consensus_results = interactive_consensus_annotation(
    ...
    models=["gpt-4o", "claude-3-7-sonnet-20250219", "gemini-1.5-pro", "qwen-max-2025-01-25"],  # Mehrere LLMs für Konsensus
...
#   - Anthropic-Modelle: 'anthropic/claude-3.7-sonnet', 'anthropic/claude-3.5-sonnet', 'anthropic/claude-3.5-haiku', 'anthropic/claude-3-opus'
...
2. **OpenAI-Modelle**
   ...
   - `gpt-4o` - Starke Leistung bei verschiedenen Zelltypen
   - `gpt-4.1` - Neueste GPT-4-Variante

3. **Google Gemini-Modelle**
   - `gemini-2.5-pro` - Spitzenleistung
   - `gemini-2.0-flash` - Gute Leistung mit schnellerer Verarbeitung

4. **Andere leistungsstarke Modelle**
   - `deepseek-r1` / `deepseek-reasoner` - Starke Argumentationsfähigkeiten
   - `qwen-max-2025-01-25` - Hervorragend für wissenschaftliche Kontexte
   - `grok-3-latest` - Fortgeschrittenes Sprachverständnis
...
5. **Standardverhalten**: 
   ...
   - Python: Standardmäßig `qwen-max-2025-01-25` (ein leistungsstarkes Modell) mit `claude-3-5-sonnet-latest` als Fallback
