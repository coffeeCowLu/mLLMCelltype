...
class TestConsensus:
    ...
    def test_check_consensus(self, mock_check_consensus_with_llm):
        ...
        mock_check_consensus_with_llm.return_value = (
            ...
            {"1": 0.85, "2": 0.60, "3": 0.95},  # Note: cluster 2's consensus proportion is below threshold
    ...
    def test_interactive_consensus_annotation(self, mock_process_controversial, mock_check_consensus, 
        ...
        result = interactive_consensus_annotation(
            ...
            species="human",
            models=["gpt-4o", "claude-3-opus", "gemini-1.5-pro"],  # Using real model names
        ...
        assert "discussion_logs" in result  # Note: field name is discussion_logs not discussion_history
