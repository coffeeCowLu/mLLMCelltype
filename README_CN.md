...
**🇨🇳 中国大陆用户特别推荐**：我们强烈建议中国大陆用户使用网页版 mLLMCelltype！使用网页版可以完全避免 API 连接和网络访问问题，无需配置任何 API 密钥或特殊网络设置。网页版提供与本地版本相同的强大功能，并且已经预配置了所有必要的模型访问权限。这是中国大陆用户最便捷、最稳定的使用方式。
...
**为什么选择网页版？**
- ✅ **零配置**：无需申请和配置任何 API 密钥
- ✅ **无网络限制**：完全避免国内访问国外 API 的网络问题
- ✅ **即开即用**：上传数据即可开始分析，无需安装任何软件
- ✅ **功能完整**：提供与本地版本相同的所有功能
- ✅ **稳定可靠**：已预配置所有模型访问权限，确保稳定运行
