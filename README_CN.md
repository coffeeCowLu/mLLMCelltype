...
在 49 个基准数据集中（[Yang et al., 2026](https://doi.org/10.1038/s42003-026-10420-8)），mLLMCelltype 的平均准确率达到 77.2%，比表现最好的单 LLM 基线（61.5%）提高 15.7 个百分点。
...
mLLMCelltype 论文已在 *Communications Biology* 在线发表。正式引用为：Yang, C., Zhang, X., & Chen, J. (2026). Large language model consensus substantially improves the cell type annotation accuracy for scRNA-seq data. *Communications Biology*. https://doi.org/10.1038/s42003-026-10420-8
...
Yang, C., Zhang, X., & Chen, J. (2026). Large language model consensus substantially improves the cell type annotation accuracy for scRNA-seq data. *Communications Biology*. [阅读论文](https://doi.org/10.1038/s42003-026-10420-8)
