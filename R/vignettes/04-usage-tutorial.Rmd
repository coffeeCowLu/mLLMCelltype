...
consensus_results <- create_consensus(
  ...
  controversy_threshold = 0.5  # Threshold for identifying controversial clusters
)
```
...
The `controversy_threshold` parameter controls which clusters are considered controversial and require discussion:
...
consensus_results_low_threshold <- create_consensus(
  ...
  model = "claude-3-7-sonnet-20250219",
  api_key = Sys.getenv("ANTHROPIC_API_KEY"),
  controversy_threshold = 0.3  # Lower threshold
)
...
consensus_results_high_threshold <- create_consensus(
  ...
  model = "claude-3-7-sonnet-20250219",
  api_key = Sys.getenv("ANTHROPIC_API_KEY"),
  controversy_threshold = 0.7  # Higher threshold
)
```
