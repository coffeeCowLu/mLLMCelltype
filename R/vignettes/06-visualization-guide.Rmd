...
mLLMCelltype includes enhanced marker gene visualization functions that create publication-ready bubble plots and heatmaps showing marker gene expression patterns across annotated cell types. These visualizations seamlessly integrate with the consensus annotation workflow.
...
<img src="figures/png/marker_bubble_plot.png" alt="Marker Gene Bubble Plot" width="90%"/>
...
<img src="figures/png/marker_heatmap.png" alt="Marker Gene Heatmap" width="90%"/>
...
4. **File Formats**: Save as PNG for presentations, PDF for publications
5. **Resolution**: Use 300 DPI for publication-quality figures
