...
- `claude-opus-4-1-20250805` (excellent for complex reasoning)
- `o1` (advanced reasoning)
- `gpt-5` (strong performance)
...
free_models <- c(
  ...
  "deepseek/deepseek-r1:free"                         # Microsoft MAI-DS-R1 (free)
)
...
- **Anthropic Claude Sonnet 4.5** (`claude-sonnet-4-5-20250929`): Latest and most intelligent, excellent biological knowledge
- **Anthropic Claude Opus 4.1** (`claude-opus-4-1-20250805`): Best for complex reasoning and detailed analysis
- **OpenAI GPT-5** (`gpt-5`): Strong overall performance, good biological knowledge
- **Google Gemini 2.5 Pro** (`gemini-2.5-pro`): Top-tier performance with detailed reasoning
...
- **Microsoft MAI-DS-R1** (`deepseek/deepseek-r1:free`): Reliable with good response time
