...
### Using the DiscussionLogger

mLLMCelltype provides a `DiscussionLogger` class for detailed logging of the consensus process:

```{r}
# Create a custom logger
logger <- DiscussionLogger$new(base_dir = "logs")

# Start logging a cluster discussion
logger$start_cluster_discussion(
  cluster_id = "0",
  tissue_name = "human PBMC",
  marker_genes = "CD3D, CD3E, CD2, IL7R, LTB"
)

# Log a discussion entry
logger$log_entry("INFO", "Starting analysis of cluster 0")
...
# Log final consensus
logger$log_final_consensus(
  final_cell_type = "T cells",
  summary = "All models agreed on T cells based on CD3 markers"
)

# End the cluster discussion
