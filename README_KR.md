...
🎉 **2025년 4월**: 저희는 프리프린트 발표 후 1주일도 채 안 되어 mLLMCelltype가 GitHub에서 100개의 별표를 넘었다는 사실을 기쁨게 발표합니다! 또한 다양한 마디어와 콘텐츠 크리에이터들의 많은 보도를 보았습니다. 별표, 공유, 기여를 통해 이 프로젝트를 지원해주신 모든 분들께 진심어린 감사를 드립니다. 여러분의 열정이 mLLMCelltype의 지속적인 개발과 개선을 이끌는 원동력입니다.
